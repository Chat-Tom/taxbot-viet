...
export default function CustomerLogin() {
  ...
  return (
    <div className="min-h-screen vietnam-bg-with-stars">
      <Header />
      
      <div className="container mx-auto px-4 pt-20 pb-12 flex justify-center">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        required
                        className={`mobile-input pl-10 ${validationErrors.phone ? 'border-red-500' : ''}`}
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <Input
                        ...
                        required
                        className={`mobile-input pr-10 ${validationErrors.password ? 'border-red-500' : ''}`}
                      />
                      <button
                        type="button"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        required
                        className={`mobile-input pl-10 ${validationErrors.name ? 'border-red-500' : ''}`}
                      />
                    </div>
